        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4 lg:gap-8">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="flex gap-3">
              {/* Facebook */}
              <button className="flex size-10 items-center justify-center rounded-full bg-accent text-muted-foreground transition-all hover:bg-primary hover:text-primary-foreground">
